...
// /**
//  * GPL Track — Entrées de GPL
//  * Converted from static HTML to a single-file React component.
//  * Same token/utility-class approach as the dashboard conversion:
//  * all custom design tokens and their derived classes are defined
//  * in the <style> block below, since this environment doesn't run
//  * a Tailwind JIT compiler.
//  */
...
//     label: "Réceptions",
//     value: "24",
//     note: "6 dépôts concernés",
//     noteClass: "text-muted-foreground",
//   },
//   {
//     label: "Produit principal",
//     value: "Super",
//     note: "1 020 t réceptionnées",
//     noteClass: "text-muted-foreground",
//   },
// ];

// const CITY_ENTRIES = [
//   { city: "Douala", qty: "680 t", width: "83%" },
//   { city: "Yaoundé", qty: "420 t", width: "50%" },
//   { city: "Kribi", qty: "310 t", width: "40%" },
//   { city: "Bafoussam", qty: "230 t", width: "25%" },
// ];

// const PRODUCT_SPLIT = [
//   { label: "Super", value: "1 020 t", note: "62% des entrées", surface: "bg-secondary", labelClass: "text-secondary-foreground", noteClass: "text-primary" },
//   { label: "Gasoil", value: "620 t", note: "38% des entrées", surface: "bg-muted", labelClass: "text-muted-foreground", noteClass: "text-muted-foreground" },
// ];

// const RECEPTIONS = [
//   { date: "28/08/2026", ref: "ENT-0828-024", city: "Douala", depot: "Bonabéri", product: "Super", qty: "240 t", status: "Validée" },
//   { date: "26/08/2026", ref: "ENT-0826-023", city: "Kribi", depot: "Port", product: "Gasoil", qty: "180 t", status: "Validée" },
//   { date: "24/08/2026", ref: "ENT-0824-022", city: "Yaoundé", depot: "Nsam", product: "Super", qty: "155 t", status: "Validée" },
// ];
...
//             <div>
//               <p className="text-sm font-medium text-primary">Mouvements entrants</p>
//               <h1 className="mt-1 text-2xl font-heading font-bold text-balance">Entrées de GPL</h1>
//               <p className="mt-2 text-sm text-muted-foreground">
//                 Réceptions par ville, dépôt, mois et catégorie de produit.
//               </p>
//             </div>
...
//           {/* City breakdown + product split */}
//           <section className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-3">
//             <div className="rounded-xl border border-border bg-card p-6 xl:col-span-2">
//               <h2 className="text-lg font-heading font-semibold">Entrées par ville</h2>
//               <p className="mt-1 text-sm text-muted-foreground">Volume réceptionné en août 2026</p>
...
//               <h2 className="text-lg font-heading font-semibold">Répartition produit</h2>
...
//             <div className="p-6">
//               <h2 className="text-lg font-heading font-semibold">Historique des réceptions</h2>
//               <p className="mt-1 text-sm text-muted-foreground">
//                 Entrées validées sur les dépôts du marketer
//               </p>
//             </div>
...
//                       <td className="px-6 py-4 font-medium">{r.ref}</td>
          ...
          <section className="mt-8 rounded-2xl border border-border bg-card p-5 shadow-soft">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {FILTERS.map((filter) => (
                <button
                  key={filter}
                  className="filter-btn flex min-h-11 items-center justify-between rounded-xl border border-input bg-background px-4 text-sm text-foreground"
                >
          ...
          <section className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {KPI_CARDS.map((card) => (
              ...
              >
                ...
                <p className={`mt-1.5 text-xs font-medium ${card.noteClass}`}>
                  {card.note}
                </p>
              </div>
            ))}
            ...
            <div className="rounded-2xl border border-border bg-card p-6 shadow-soft xl:col-span-2">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Volume réceptionné en août 2026
                  </p>
                </div>
              </div>
                ...
                {CITY_ENTRIES.map((entry) => (
                  <div key={entry.city}>
                    <div className="mb-2 flex justify-between text-sm">
                      ...
                      <span className="font-semibold text-primary">{entry.qty}</span>
                    </div>
            ...
            <div className="rounded-2xl border border-border bg-card p-6 shadow-soft">
              ...
              <div className="mt-7 space-y-4">
                {PRODUCT_SPLIT.map((p) => (
                  ...
                  >
                    <p className={`text-sm font-medium ${p.labelClass}`}>
                      {p.label}
                    </p>
                    <p className="mt-1.5 text-2xl font-heading font-bold tracking-tight">
                      {p.value}
                    </p>
                    <p className={`mt-1 text-xs font-medium ${p.noteClass}`}>
                      {p.note}
                    </p>
                  </div>
                ))}
          ...
          <section className="mt-6 rounded-2xl border border-border bg-card shadow-soft overflow-hidden">
            ...
            <div className="overflow-x-auto border-t border-border">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {RECEPTIONS.map((r) => (
                    <tr key={r.ref} className="table-row border-t border-border">
