...
export default function ChangerMotDePasse() {
  ...
  const handleSubmit = (e) => {
    ...
    setError("");
    // TODO: envoyer { oldPassword, newPassword } au backend pour
    // vérifier l'ancien mot de passe et finaliser le changement,
    // puis rediriger vers /tableau.
  };
      ...
      <div className="flex w-full md:w-1/2 items-center justify-center bg-background p-6 sm:p-10">
        <div className="w-full max-w-sm">
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="submit-btn w-full rounded-lg py-3 text-sm font-semibold">
