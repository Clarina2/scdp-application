...
//  * All custom design tokens (colors, radius, shadow) and the utility
//  * classes derived from them are defined in the <style> block below,
//  * since this environment doesn't run a Tailwind JIT compiler — only
//  * core Tailwind utility classes (flex, grid, p-*, text-sm, etc.) are
...
//   // Simple inline icon stand-in (no external icon library dependency).
...
//     value: "4 820 t",
//     note: "+8,4% depuis juillet",
//     noteClass: "text-primary",
//   },
//   {
//     label: "Entrées du mois",
//     value: "1 640 t",
//     note: "24 réceptions validées",
//     noteClass: "text-muted-foreground",
//   },
//   {
//     label: "Sorties du mois",
//     value: "1 285 t",
//     note: "38 expéditions enregistrées",
//     noteClass: "text-muted-foreground",
//   },
//   {
//     label: "Dépôts surveillés",
//     value: "6",
//     note: "Dans 4 villes",
//     noteClass: "text-muted-foreground",
//   },
...
//             <div>
//               <p className="text-sm font-medium text-primary">Bonjour, Espace marketer</p>
//               <h1 className="mt-1 text-2xl font-heading font-bold text-balance">
...
//               <button className="flex min-h-11 items-center gap-2 rounded-lg border border-border bg-card px-4 text-sm font-medium">
//                 <IconPlaceholder className="text-primary" />
//                 Août 2026
//               </button>
//               <button className="flex size-11 items-center justify-center rounded-lg border border-border bg-card">
...
//               <IconPlaceholder className="text-primary" />
//               <h2 className="text-lg font-heading font-semibold">Filtres de consultation</h2>
//             </div>
//             <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-4">
//               {FILTERS.map((filter) => (
//                 <button
//                   key={filter}
//                   className="flex min-h-11 items-center justify-between rounded-lg border border-input px-3 text-left text-sm"
//                 >
//                   <span>{filter}</span>
//                   <IconPlaceholder />
//                 </button>
...
//                     <i className="size-2 rounded-full bg-primary inline-block" />
//                     Entrées
//                   </span>
//                   <span className="flex items-center gap-1">
//                     <i className="size-2 rounded-full bg-tertiary inline-block" />
//                     Sorties
//                   </span>
//                 </div>
//               </div>

//               <div className="mt-6 grid h-56 grid-cols-6 items-end gap-4 border-b border-border px-3">
//                 {monthlyBars.map((bar) => (
//                   <div key={bar.label} className="flex h-full flex-col justify-end gap-1">
//                     <div
//                       className="rounded-t bg-primary"
//                       style={{ height: `${bar.in}px` }}
//                     />
//                     <div
//                       className="rounded-t bg-tertiary"
//                       style={{ height: `${bar.out}px` }}
//                     />
//                   </div>
//                 ))}
//               </div>
...
//               <h2 className="text-lg font-heading font-semibold">Stock par produit</h2>
//               <p className="mt-1 text-sm text-muted-foreground">Répartition actuelle</p>
//               <div className="mt-7 space-y-6">
//                 <div>
//                   <div className="flex justify-between text-sm">
//                     <span>Super</span>
//                     <span className="font-semibold">2 940 t</span>
//                   </div>
...
//                   <div className="flex justify-between text-sm">
//                     <span>Gasoil</span>
//                     <span className="font-semibold">1 880 t</span>
//                   </div>
//                   <div className="mt-2 h-3 rounded-full bg-secondary">
//                     <div className="h-3 rounded-full bg-tertiary" style={{ width: "50%" }} />
//                   </div>
...
//               <div>
//                 <h2 className="text-lg font-heading font-semibold">Mouvements récents</h2>
//                 <p className="mt-1 text-sm text-muted-foreground">
//                   Dernières opérations sur vos dépôts
//                 </p>
//               </div>
//               <button className="min-h-11 rounded-lg px-3 text-sm font-semibold text-primary hover:bg-secondary">
//                 Voir les entrées
//               </button>
//             </div>
...
//                     <th className="px-6 py-3 font-medium">Ville / dépôt</th>
//                     <th className="px-6 py-3 font-medium">Produit</th>
//                     <th className="px-6 py-3 font-medium">Mouvement</th>
...
//                           className={
//                             m.type === "Entrée"
//                               ? "rounded-full bg-secondary px-2 py-1 text-xs font-semibold text-primary"
//                               : "rounded-full bg-accent px-2 py-1 text-xs font-semibold text-foreground"
//                           }
//                         >
//                           {m.type}
//                         </span>
